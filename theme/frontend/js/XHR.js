var XHR = (function () {
    ...
    function buttonStyle(button) {
        ...
        button.innerHTML = `<div class="r-s-loader"></div><style>.r-s-loader{position:absolute;left:50%;top:50%;border:5px solid ${styles.color
            };border-radius:50%;border-top:5px solid ${styles.color
            };border-bottom:5px solid ${styles.color
            };border-left:5px solid transparent;border-right:5px solid transparent;width:${buttonRect.height - 16
            }px;height:${buttonRect.height - 16
